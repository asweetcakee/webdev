...
const favoriteBlog = {
  oneBlog: listWithOneBlog,
  fewBlogs: listWithMoreThanOneBlog,
  sharedMaxLikedBlogs: listWithEqualHighestLikesCount
}

const mostBlogs = {
  oneBlog: listWithOneBlog,
  mostBlogsByOneAuthor: listWithBlogsFromMoreThanOneAuthor,
  blogsWithUniqueAuthors: listWithMoreThanOneBlog,
  firstAuthorWithMostBlogs: listWithSomeAuthorsThatHaveEqualBlogsCount
}

const mostLikes = {
  oneBlog: listWithOneBlog,
  fewBlogs: listWithMoreThanOneBlog,
  blogsShareEqualLikes: listWithAuthorsThatShareSameLikesCount,
