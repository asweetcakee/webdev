## Full Stack Open 2025 — Part 4
This directory contains my **backend implementation** for **Part 4** of the [Full Stack Open 2025](https://fullstackopen.com/en/part4) course.  
...
|-----------------------------------|-------------|----------------------------------------------------------------------------------------|
| `Blog List steps`                 | 4.1 – 4.2   | Basic GET and POST endpoints, middleware setup, MongoDB connection, modular structure  |
| `Helper Functions and Unit Tests` | 4.3 – 4.7   | Helper functions and unit testing                                                      |
| `Blog List tests`                 | 4.8 – 4.12  | Integration testing with Supertest, async/await patterns, Mongoose models              |
| `Blog List Expansions`            | 4.13 – 4.23 | CRUD API, integration tests, middleware, password hashing, token-based authentication  |
